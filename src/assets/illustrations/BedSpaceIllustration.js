...
function BedSpaceIllustration({ ...other }) {
  ...
  return (
    <Box display="flex" height="90px" width="130px" style={{ margin: '18px' }} {...other}>
      <svg width="100%" height="100%" viewBox="0 0 210 150" xmlns="http://www.w3.org/2000/svg">
        <path
          fill="url(#a)"
...
export default memo(BedSpaceIllustration);

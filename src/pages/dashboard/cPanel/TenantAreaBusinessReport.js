  ...
  return (
    <Container>
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={6} md={4}>
          <PropertyViews title="Property Views" data={tenantAreaBusinessReport?.properties || []} />
        </Grid>

        <Grid item xs={12} sm={6} md={4}>
          <RoommatesMatch title="Roommates match your Property" area={area} budget={getBudget()} />
        </Grid>
